...
public class GptTwoDifferentMelodies {
    public static void main(String[] args) throws MidiUnavailableException, InterruptedException, InvalidMidiDataException {
     ...
     // Melody 1
        ...
        track1.add(createNoteEvent(72, tick + 200, 100)); // C5
        ...
        track1.add(createNoteEvent(62, tick + 600, 100)); // D4
        ...
        track2.add(createNoteEvent(60, tick + delayTicks, 100)); // C4
        track2.add(createNoteEvent(72, tick + delayTicks + 200, 100)); // C5
        track2.add(createNoteEvent(65, tick + delayTicks + 300, 100)); // F4
        track2.add(createNoteEvent(67, tick + delayTicks + 400, 100)); // G4
        track2.add(createNoteEvent(69, tick + delayTicks + 500, 100)); // A4
        track2.add(createNoteEvent(62, tick + delayTicks + 600, 100)); // D4
        track2.add(createNoteEvent(64, tick + delayTicks + 700, 100)); // E4
